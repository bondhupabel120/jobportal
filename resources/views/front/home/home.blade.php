...
@section('body')
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('/') }}front/images/banner3.jpg');height: 80%;width: 100%" data-stellar-background-ratio="0.5">
                    ...
                    <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                        ...
                        <div class="mb-4 mb-md-0 mr-5">
                            ...
                            <div class="job-post-item-body d-block d-md-flex">
                                <div class="mr-3"><span class="icon-money"></span> <a href="#">{{ $job->salary }}</a></div>
                        ...
                        <div class="ml-auto d-flex">
                            <a href="{{ route('send-application') }}" class="btn btn-primary py-2 mr-1">Apply Job</a>
                        </div>
                    </div>
                </div><!-- end -->
                @endforeach
