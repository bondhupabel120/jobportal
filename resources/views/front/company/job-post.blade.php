        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    <form action="{{ route('new-company-job-post') }}" method="POST" class="p-5 bg-white">
                        @csrf
                        <h3 class="text-center text-success">Create a Job Post</h3>

                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="fullname">Job Title</label>
                                <input type="text" name="job_title" id="fullname" class="form-control" placeholder="eg. Web Designer">
                            </div>
                        </div>
                        ...
                        <div class="row form-group mb-4">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" name="salary" class="form-control" placeholder="e.g 30,000">
                            </div>
                        </div>

                        <div class="row form-group mb-4">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="fullname">Loacation</label>
                        ...
                        <div class="row form-group mb-4">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <input type="text" name="country" class="form-control" placeholder="e.g Bangladesh">
                            </div>
                        </div>
