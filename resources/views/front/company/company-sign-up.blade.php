    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-8 pb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('new-company-sign-up') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="business_name" class="form-control" placeholder="Business Name" required onblur="emailCheck(this.value);"/>
                                </div>
                            </div>
                            <div class="form-group row">
