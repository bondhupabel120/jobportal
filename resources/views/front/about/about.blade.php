...
@section('body')
    <section class="ftco-about d-md-flex" style="margin-top: 150px">
        <div class="one-half img" style="background-image: url({{ asset('/') }}front/images/about.jpg);"></div>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url({{ asset('/') }}front/images/bg_1.jpg);" data-stellar-background-ratio="0.5">
        <div class="container">
